  ...
  return (
    <div>
      <footer className={`footer xl:px-24 py-10 px-4 text-base-content ${
        ...
        <nav>
          <header className="footer-title text-zinc-100">Useful links</header>
        ...
        <nav>
          <header className="footer-title text-zinc-100">Main Menu</header>
        ...
        <nav>
          <header className="footer-title text-zinc-100">Contact Us</header>
